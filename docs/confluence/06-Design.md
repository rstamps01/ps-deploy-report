# Design Guide: VAST As-Built Report Generator
...
| Qty of Nodes | API                | `cbox.nodes` (count)                         | ‌                                                                       |
| Qty of NICs | API                | `cnode.network_interfaces` (count)           | ‌                                                                       |
...
| Qty of Nodes | API                | `dbox.nodes` (count)                         | ‌                                                                       |
| B2B enabled?                | API                | `cluster.b2b_enabled`                        | ‌                                                                       |
| VAST Code Version(s)        | API                | `cluster.vast_version`                       | ‌                                                                       |
