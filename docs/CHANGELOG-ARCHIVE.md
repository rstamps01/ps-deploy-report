...
Older release history (**v1.4.7 and earlier**) split out of [`CHANGELOG.md`](../CHANGELOG.md) to keep the active changelog lean (pipeline §11). Format: [Keep a Changelog](https://keepachangelog.com/). For v1.5.0 and newer, see the main changelog.
