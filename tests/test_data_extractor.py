...
class TestVastDataExtractor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_raw_data = {
            ...
            "network": {
                "dns": {"servers": ["8.8.8.8", "8.8.4.4"], "search_domains": ["example.com"], "enabled": True},
    ...
    def test_extract_network_configuration_partial_data(self):
        ...
        partial_data = {"network": {"dns": {"servers": ["8.8.8.8"]}, "ntp": None, "vippools": None}}
    ...
    def test_process_hardware_node_no_rack_position(self):
        ...
        node_data = {"id": "test-node", "model": "Test-Model", "serial_number": "SN123456", "status": "active"}
    ...
    def test_generate_physical_layout(self):
        ...
        dnodes = [{"id": "dnode-1", "rack_position": 10}]
...
class TestReportSection(unittest.TestCase):
    ...
    def test_report_section_creation(self):
        ...
        section = ReportSection(
            name="test_section", title="Test Section", data={"test": "data"}, completeness=0.95, status="complete"
        )
